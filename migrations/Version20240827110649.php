 ...
 */
final class Version20240827110649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonces (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, img LONGTEXT DEFAULT NULL, salary DOUBLE PRECISION NOT NULL, duration INT DEFAULT NULL, date_publish DATE NOT NULL, INDEX IDX_CB988C6FC54C8C93 (type_id), INDEX IDX_CB988C6FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE annonces ADD CONSTRAINT FK_CB988C6FC54C8C93 FOREIGN KEY (type_id) REFERENCES types (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces DROP FOREIGN KEY FK_CB988C6FC54C8C93');
